...
Shader "HeightColor"
{
	...
	SubShader
	{
		...
		{
			Gradient gradient3 = NewGradient( 0, 3, 2, float4( 0.5415502, 0.754717, 0.4592382, 0.2500038 ), float4( 0.4397418, 0.5471698, 0.1574403, 0.7499962 ), float4( 0.0162026, 0.2830189, 0, 1 ), 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
...
Node;AmplifyShaderEditor.GradientNode;3;-587.25,52.58688;Inherit;False;0;3;2;0.5415502,0.754717,0.4592382,0.2500038;0.4397418,0.5471698,0.1574403,0.7499962;0.0162026,0.2830189,0,1;1,0;1,1;0;1;OBJECT;0
...
ASEEND*/
//CHKSM=81BEC52417E22571F8B1DFEA206E98BF08120D79